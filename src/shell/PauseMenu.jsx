...
const DexIcon = (
  <svg width="14" height="14" viewBox="0 0 16 16" shapeRendering="crispEdges" style={{ display: 'block' }} aria-hidden="true">
    ...
    <>
      ...
      <aside
        ...
        <div className="brand">
          ...
          <div className="name">NICK<br/>BELY</div>
        </div>
        ...
        <div className="toggles">
          <div className="toggle-row">
            ...
            <span className={`pxswitch ${playMode ? 'on' : ''}`}
              onClick={togglePlay} role="switch" aria-checked={playMode}
              tabIndex={0}
          ...
          <div className="toggle-row">
            ...
            <span className={`pxswitch ${questsVisible ? 'on' : ''}`}
              onClick={toggleQuests} role="switch" aria-checked={questsVisible}
              tabIndex={0}
              onKeyDown={e => { if (e.key === ' ' || e.key === 'Enter') toggleQuests(); }}>
              <i />
            </span>
          ...
          <div className="toggle-row toggle-night-row">
            ...
            <span className={`pxswitch ${night ? 'on' : ''}`}
              onClick={() => update({ night: !night })} role="switch" aria-checked={night}
              tabIndex={0}
              onKeyDown={e => { if (e.key === ' ' || e.key === 'Enter') update({ night: !night }); }}>
              <i />
            </span>
